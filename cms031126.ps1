...
Add-PodeWebPage -Name 'Sample1' -ScriptBlock {
        New-PodeWebCard -Content @(
            ...
            New-PodeWebModal -Name 'Description' -AsForm -Content @(   
                New-PodeWebTextbox -Name 'MultiLine' -Multiline
            ) -ScriptBlock {
...
Add-PodeWebPage -Name 'Sample2' -ScriptBlock {
    New-PodeWebCard -Content @(
    New-PodeWebForm -Name 'Example' -ScriptBlock {
        ...
        New-PodeWebButton -Name 'Show Modal' -ScriptBlock {
            ...
            $multiline = ""
            New-PodeWebModal -Name 'Modal' -AsForm -Content @(   
                New-PodeWebTextbox -Name 'MultiLine1' -Multiline
            ) -ScriptBlock {
                Write-Host 'Submit button clicked!'
                 'UUU' + $WebEvent.Data['Multiline1'] | Out-Default
                  'UUU' + $WebEvent.Data['MediaFileName'] | Out-Default
                  $multiline = $WebEvent.Data['Multiline1'] 
